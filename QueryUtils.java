...
public final class QueryUtils {
    ...
    //Set up to help deal with extracting data from the json object
    private QueryUtils() {
    }
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            // For each article in the array, create an object
            for (int i = 0; i < results.length(); i++) {
                ...
                // Create a new News object with the title, section, date,
